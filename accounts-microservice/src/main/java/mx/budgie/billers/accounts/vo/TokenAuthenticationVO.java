 ...
 *
 */
public class TokenAuthenticationVO implements Serializable {
	...
	public TokenAuthenticationVO(){
		
	}

	public TokenAuthenticationVO(Integer expireIn, String clientAuthentication, String tokenView){
